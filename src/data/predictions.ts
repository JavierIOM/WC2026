export interface Match {
  id: string;
  matchday: number;
  round?: string;       // knockout round identifier, e.g. 'R32', 'QF', 'SF', 'F'
  dateISO: string;      // YYYY-MM-DD
  kickoffBST: string;   // "HH:MM"
  group?: string;       // absent for knockout rounds
  venue: string;
  home: string;
  away: string;
...
export const matches: Match[] = [
...

  {
    ...
    dateISO: '2026-06-28',
    kickoffBST: '20:00',
    venue: 'SoFi Stadium, Inglewood CA (roof)',
    home: 'Canada',
    away: 'South Africa',
    predHome: 2,
    predAway: 0,
...

  {
    ...
    dateISO: '2026-06-29',
    kickoffBST: '18:00',
    venue: 'NRG Stadium, Houston (roof)',
    home: 'Brazil',
    away: 'Japan',
    predHome: 2,
    predAway: 1,
...

  {
    ...
    dateISO: '2026-06-30',
    kickoffBST: '18:00',
    venue: 'AT&T Stadium, Arlington (roof)',
    home: 'Ivory Coast',
    away: 'Norway',
    predHome: 1,
    predAway: 2,
...

  {
    ...
    scorerCall: 'Raúl Jiménez',
    scorerCallType: 'score-or-assist',
    conditions: 'Altitude NEUTRALISED (both altitude nations). Tight, ET live.',
...

  {
    ...
    dateISO: '2026-07-01',
    kickoffBST: '17:00',
    venue: 'Mercedes-Benz Stadium, Atlanta (roof)',
    home: 'England',
    away: 'DR Congo',
    predHome: 2,
    predAway: 0,
    ...
    scorerCall: 'Kane',
    scorerCallType: 'score-or-assist',
    conditions: 'Roofed neutral. Kindest big-side draw; Kane firing. Deep-block caution.',
    reasoning: 'Roofed neutral. Kindest big-side draw; Kane firing. Deep-block caution.',
    actualHome: 2,
    actualAway: 1,
...

  {
    ...
    scorerCall: 'De Bruyne',
    scorerCallType: 'score-or-assist',
    conditions: 'Mild. LIVE UPSET -- Belgium wasteful, Senegal sharp. Coin-flip.',
    reasoning: 'Mild. LIVE UPSET -- Belgium wasteful, Senegal sharp. Coin-flip.',
    actualHome: 3,
    actualAway: 2,
...

  {
    ...
    scorerCall: 'Balogun',
    scorerCallType: 'score-or-assist',
    conditions: 'Mild. USA home; Pulisic doubt (Balogun pick); Džeko threat.',
    reasoning: 'Mild. USA home; Pulisic doubt (Balogun pick); Džeko threat.',
    actualHome: 2,
    actualAway: 0,
...

  {
    ...
    scorerCall: 'Oyarzabal',
    scorerCallType: 'score-or-assist',
    conditions: 'Roofed neutral. Spain unlocked (Yamal); Austria leaky.',
    reasoning: 'Roofed neutral. Spain unlocked (Yamal); Austria leaky.',
    actualHome: 3,
    actualAway: 0,
...

  {
    ...
    scorerCall: 'Ronaldo',
    scorerCallType: 'score-or-assist',
    conditions: 'Mild. Veteran clash; tight, ET live.',
    reasoning: 'Mild. Veteran clash; tight, ET live.',
    actualHome: 2,
    actualAway: 1,
  ...
  {
    id: 'switzerland-algeria',
    matchday: 4,
    round: 'R32',
    dateISO: '2026-07-03',
    kickoffBST: '04:00',
    venue: 'BC Place, Vancouver (roof)',
    home: 'Switzerland',
    away: 'Algeria',
    predHome: 2,
    predAway: 1,
    ...
    scorerCall: 'Embolo',
    scorerCallType: 'score-or-assist',
    conditions: 'Roofed neutral. Swiss organisation over leaky Algeria.',
    reasoning: 'Roofed neutral. Swiss organisation over leaky Algeria.',
    actualHome: 2,
    actualAway: 0,
...

  {
    ...
    scorerCall: 'Salah',
    scorerCallType: 'score-or-assist',
    conditions: 'Roof neutral. Salah the difference vs resilient AUS. A grind.',
...

  {
    ...
    scorerCall: 'Messi',
    scorerCallType: 'score-or-assist',
    conditions: 'Miami ~33C HUMID -- heat aids CV deep block. Messi\'s home + record chase; ARG a tier above.',
    reasoning: 'Miami ~33C HUMID -- heat aids CV deep block. Messi\'s home + record chase; ARG a tier above.',
    actualHome: 3,
    actualAway: 2,
...

  {
    ...
    scorerCall: 'Luis Díaz',
    scorerCallType: 'score-or-assist',
    conditions: '~30C minor. Colombia a clear cut above 3rd-place Ghana.',
    reasoning: '~30C minor. Colombia a clear cut above 3rd-place Ghana.',
    actualHome: 1,
    actualAway: 0,
